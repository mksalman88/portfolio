...
permalink: /maps/bronx-energy-burden/
category: Data
---

Energy Burden (%) is the share of a household’s income spent on home energy costs. The energy burden shown here comes from the U.S Department of Energy's LEAD Tool (2022) at the tract level. I summed annual spending on electricity, gas, and other fuels across households in each tract and divided by total household income to express the share as a percentage. Neighborhoods with lower incomes and older, less efficient housing tend to show higher energy burdens. Parks, industrial areas, or tracts with few or no households often have missing or distorted values, so those tracts are masked on the map. The map was built in Python with GeoPandas and Folium; sources are listed below.
